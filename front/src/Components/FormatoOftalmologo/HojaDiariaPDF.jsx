...
const generarPDF = (nombre, cedula, fichasMedicas, detallesPacientes, fechaActual) => {
    ...
    documento.text('HOJA DIARIA OFTALMOLOGIA', getCenteredXPosition('HOJA DIARIA OFTALMOLOGIA', maxWidth) + 20, 30);
    ...
    documento.save(`HOJA_DIARIA_OFTALMOLOGIA_${nombre}_${fechaActual}.pdf`);
};
