                                    ...
                                    <div className="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form>
                                            ...
                                            <div className="form-outline mb-3">
                                                <input type="no_trabajador" id="no_trabajador" className="form-control form-control-lg entrada" placeholder="MRR009" />
                                                <label className="form-label etiquetas" htmlFor="form2Example17">Número de trabajador</label>
                                            </div>

                                            <div className="form-outline mb-3">
                                                <div className="input-group">
                                                    <input type="password" id="contrasenia" className="form-control form-control-lg entrada" placeholder="********" />
                                                </div>
                                            ...
                                            <div className="pt-1 mb-3">
                                                <button className="btn btn-guardar btn-lg btn-block">Entrar</button>
                                            </div>
