...
export function TablaNutriologia() {
    const { token } = useAuth()
    ...
    const indexOfLastFicha = currentPage * fichasPorPagina;
    const indexOfFirstFicha = indexOfLastFicha - fichasPorPagina;
    const fichasActuales = fichasMedicas.slice(indexOfFirstFicha, indexOfLastFicha);
    ...
    return (
        <div className="container">
            ...
            <div>
                ...
                <label className="etiqueta" htmlFor="nombre_nutri">Nombre del nutriólogo</label>
                <input type="text" id="nombre_nutri" name="nombre_nutri" className="entrada" value={nombre} readOnly />
