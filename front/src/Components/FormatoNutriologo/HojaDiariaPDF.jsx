...
const generarPDF = (nombre, cedula, fichasMedicas, detallesPacientes, fechaActual) => {
    ...
    documento.text('HOJA DIARIA NUTRIOLOGO', getCenteredXPosition('HOJA DIARIA NUTRIOLOGO', maxWidth) + 20, 30);
    ...
    documento.save(`HOJA_DIARIA_NUTRIOLOGO_${nombre}_${fechaActual}.pdf`);
};
