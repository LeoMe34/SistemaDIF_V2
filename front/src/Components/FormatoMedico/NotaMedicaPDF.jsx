...
const generarPDF = (detallePaciente, noExpediente, data, empleado, fechaActual, horaActual) => {
    ...
    yPosition = checkAddPage(yPosition, 10);
    yPosition = addTextWithWrap(`SEXO: ${detallePaciente?.datosPersonalesPacient?.sexo}`, mitadPagina, yPosition);
    yPosition = checkAddPage(yPosition, 10);
    yPosition = addTextWithWrap(`SERVICIO: ${data.servicio}`, 20, yPosition);
    yPosition = checkAddPage(yPosition, 10);
    ...
    yPosition = checkAddPage(yPosition, 10);
    yPosition = addTextWithWrap(`OBSERVACIONES: ${data.observaciones}`, 20, yPosition, maxWidth);
    yPosition = checkAddPage(yPosition, 10);
    ...
    documento.save(`Nota_Medica_${noExpediente}.pdf`);
};
