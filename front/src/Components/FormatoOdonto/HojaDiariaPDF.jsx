...
const generarPDF = (nombre, cedula, historialOdonto,diagnosticos, detallesPacientes, fechaActual) => {
    ...
    documento.text('HOJA DIARIA ODONTOLOGIA', getCenteredXPosition('HOJA DIARIA ODONTOLOGIA', maxWidth) + 20, 30);
    ...
    documento.save(`HOJA_DIARIA_ODONTOLOGIA_${nombre}_${fechaActual}.pdf`);
};
